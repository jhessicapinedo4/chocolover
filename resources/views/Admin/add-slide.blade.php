                ...
                <div class="section-menu-left">
                    <div class="box-logo">
                        <a href="index.html" id="site-logo-inner">
                            <img class="" id="logo_header" alt="" src="imagenes/logo.png"
                                data-light="imagenes/logo.png" data-dark="imagenes/logo.png">
                        </a>
                    ...
                    <div class="header-dashboard">
                        <div class="wrap">
                            <div class="header-left">
                                <a href="index-2.html">
                                    <img class="" id="logo_header_mobile" alt="" src="imagenes/logo.png"
                                        data-light="imagenes/logo.png" data-dark="imagenes/logo.png"
                                        data-width="154px" data-height="52px" data-retina="imagenes/logo.png">
                                </a>
                                <div class="button-show-hide">
                                    <i class="icon-menu-left"></i>
                                </div>
